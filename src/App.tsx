...
function App() {
  ...
  return React.createElement('section', { className: 'App' },
    React.createElement(ScheduleComponent, { height: '550px', selectedDate: new Date(2023, 1, 15), eventSettings: eventSettings },
      React.createElement(Inject, { services: [Day, Week, WorkWeek, Month, Agenda] })
    )
  );
}
